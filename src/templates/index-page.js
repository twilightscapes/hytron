...
<p>Hytron’s Quality Management System (QMS) is <a style={{textDecoration:'underline'}} href="../iso-cert.pdf" title="View Certification" target="_blank">ISO 9001:2015 and AS9100D certified</a> which is the standard for various high demand industries. As a certified contract manufacturer, this certification underscores our commitment to quality and on-time delivery of the products and services we provide to our customers.</p>
...
ISO 9001:2015 and AS9100D certified
  <a href="../iso-cert.pdf" target="_blank" className="" style={{margin:'', textDecoration:'none'}}>
  <StaticImage placeholder="blurred" layout="constrained" src="../../static/assets/iso-cert.webp" alt="Hytron ISO Certification" style={{height:'auto', position:'', zIndex:'', top:'',border:'6px solid !important', borderRadius:'12px', objectFit:'contain',}} />
</a>
</div>
<br /><br />
